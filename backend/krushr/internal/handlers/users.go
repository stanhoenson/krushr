...
func RegisterUserRoutes(r *gin.Engine) {
	...
	{
		routes.GET("", wrappers.RoleWrapper([]string{constants.AdminRoleName}, GetAll[models.User]))
		routes.POST("", wrappers.RoleWrapper([]string{constants.AdminRoleName}, func(ctx *gin.Context) {
			Post(ctx, func(requestBody *models.PostUserBody) error {
				return nil
		...
		routes.PUT("", wrappers.RoleWrapper([]string{constants.AdminRoleName}, func(ctx *gin.Context) {
			Put(ctx, func(requestBody *models.PutUserBody) error {
				return nil
